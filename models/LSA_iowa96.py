...
class Encoder(BaseModule):
    ...
    def __init__(self, input_shape, code_length):
        ...
        :param input_shape: the shape of IOWA96 samples.
...
class Decoder(BaseModule):
    ...
    def __init__(self, code_length, deepest_shape, output_shape):
        ...
        :param output_shape: the shape of IOWA96 samples.
        """
...
class LSAIOWA96(BaseModule):
    """
    LSA model for IOWA96 one-class classification.
    """
